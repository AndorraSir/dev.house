    ...
    <div class="container center-search">
        ...
        <div class="search-form">
            <form class="form-inline">
                ...
                <label class="checkbox">
                <input id="search_option_is_featured" type="checkbox" class="col-1" value="true<?php _l('is_featured'); ?>" <?php echo search_value('is_featured', 'checked'); ?>/><?php _l('is_featured'); ?>
                </label>
