...
<?php _widget('top_ads');?>
<a id="content"></a>
<div class="wrap-content pt-5 pb-5" style="margin-top:100px;">
    <div class="container">
      <!--   <div class="row">
        <?php _widget('center_defaultcontent');?>
        <?php _widget('center_imagegallery');?> -->
        <div class="row">
           <div class="col-sm-12"> <h1 class="mb-4"><?php echo lang('CalculatorTitle')?></h1></div>
                <div class="col-sm-6">

                    <form action="<?php echo $_SERVER["PHP_SELF"]?>" method="POST">
                        <div class="form-group">
                            <span><?php echo lang('Importe')?>:</span>
                ...
                if($_POST["importe"] && $_POST["anos"] && $_POST["interes"])
                {
                    ...
                    echo "<div><?php echo $_POST["interes"]?>: ".number_format($deuda,2,",",".")." €";
