...
<?php endif;?>       
      ...
      <div class="container">
        <div class="property_content row">
          ...
          <div class="row">
            ...
            <div id="myamenities" class="col-sm-6" style="display:none">
              <?php if(isset($category_options_21) && $category_options_count_21>0): ?>
              <h2 style="display: none">{options_name_21}</h2>
              <ul class="amenities">
                {category_options_21}
                {is_checkbox}
                <li>
              ...
              <h2 style="display: none">{options_name_52}</h2>
              <ul class="amenities">
                {category_options_52}
                {is_checkbox}
                <li>
              ...
              <h2 style="display: none">{options_name_43}</h2>
              <ul class="amenities">
                {category_options_43}
                {is_text}
                <li>
          ...
          <h4><?php _che($options_name_76); ?></h4>
      ...
      <div class="container hide">
        ...
        <div class="ad-gallery" id="gallery">
          ...
          <div class="ad-controls">
            ...
            {has_page_documents}
            <h4>{lang_Filerepository} FFFFFFFF</h4>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="form-group col-sm-6">
            ...
            <div id="form" class="property-form ggg">
              <h2>{lang_Bookingform}</h2>
              {validation_errors}
              {form_sent_message}
              <form method="post" class="hahah" action="{page_current_url}#form">
                <label>{lang_FirstLast}</label>
                <input class="form-control {form_error_firstname}" name="firstname" type="text" placeholder="{lang_FirstLast}" value="{form_value_firstname}" />
                <label>{lang_Phone}</label>
                <input class="form-control {form_error_phone}" name="phone" type="text" placeholder="{lang_Phone}" value="{form_value_phone}" />
                <label>{lang_Email}</label>
                <input class="form-control {form_error_email}" name="email" type="text" placeholder="{lang_Email}" value="{form_value_email}" />
                <label>{lang_Address}</label>
                <input class="form-control {form_error_address}" name="address" type="text" placeholder="{lang_Address}" value="{form_value_address}" />
                {is_purpose_rent}
                ...
                <input class="form-control {form_error_todate}" id="datetimepicker2" name="todate" type="text" placeholder="{lang_ToDate}" value="{form_value_todate}" />
                {/is_purpose_rent}
                ...
                <input class="form-control  captcha {form_error_captcha}" name="captcha" type="text" placeholder="{lang_Captcha}" value="" />
                <br style="clear: both;" />
            ...
            <div id="form" class="property-form">
              ...
              <form method="post" action="{page_current_url}#form">
                <div class="row mb-3">
                  <div class="col-sm-6">
                    <input class="form-control {form_error_firstname}" name="firstname" type="text" placeholder="{lang_FirstLast}" value="{lang_FirstLast}" />
                  </div>
                  <div class="col-sm-6">
                    <input class="form-control {form_error_phone}" name="phone" type="text" placeholder="{lang_Phone}" value="{lang_Phone}" />
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <textarea class="form-control  {form_error_message}" name="message" rows="2" placeholder="{lang_Message}"></textarea>
                  </div>
                  <div class="col-sm-6">
                    <button type="submit" class="btn btn-info col-sm-12 align-bottom">{lang_Send}</button>
                  </div>
                </div>
              </form>
            </div>
