<div class="head-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <a class="logo pull-left" href="{homepage_url_lang}"></a>
                <a class="logo-over pull-left" href="{homepage_url_lang}"></a>
                   ...
                   <div class="btn-group">
                       <?php
                        ...
                        <button type="button" class="btn btn-default"><?php   
                          ...
                          {
                              $flag_icon = '&nbsp; <img src="'.'admin-assets/img/flags/'.$this->data['lang_code'].'.png" alt="" />';
                          }
