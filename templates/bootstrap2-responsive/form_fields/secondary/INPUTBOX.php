...
<div class="<?php echo $class_add; ?>" style="<?php _che($field->style); ?>">
    <input type="text" option_id="<?php echo $f_id; ?>" class="form-control input_am<?php echo $direction;?>  id_<?php echo $f_id; ?> <?php echo $class_add; ?>" placeholder="<?php echo $placeholder ?><?php echo $suf_pre; ?>" hidefocus="true">
</div><!-- /.form-group -->