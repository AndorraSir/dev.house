...
//                                                                ), true, 1, 'package_last_payment DESC');
            ...
            if(isset($repository_id) && isset($this->data['files'][$repository_id]) && count($this->data['files'][$repository_id]) > 0)
            {
...
//                                    echo "unset\r\n";
	...
	public function index ()
	{
        ...
        $paginated_agents = $this->user_m->get_counted('type LIKE \'AGENT%\' AND activated=1 AND NOT property_id IS NULL', FALSE, $agent_per_page, 'properties_count DESC, user_id', $offset, $search_agent);
