...
//            $this->uploadhandler->generate_response($response);
    ...
    //                }
                    ...
                    else if(file_exists(FCPATH.'admin/img/icons/filetype/'.get_file_extension($file->name).'.png'))
                    {
                        $file->thumbnail_url = base_url('admin/img/icons/filetype/'.get_file_extension($file->name).'.png');
                    }
