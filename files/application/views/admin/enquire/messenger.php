<link rel="stylesheet" href="<?php echo base_url('admin/js/jnicol-trackpad-scroll-emulator/css/trackpad-scroll-emulator.css')?>" />
<script src="<?php echo base_url('admin/js/jnicol-trackpad-scroll-emulator/jquery.trackpad-scroll-emulator.js')?>"></script>
