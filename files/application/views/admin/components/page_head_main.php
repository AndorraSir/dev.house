...
<head>
    ...
    <!-- prettyPhoto -->
    <link rel="stylesheet" href="<?php echo base_url('assets/style/prettyPhoto.css')?>">   
    <!-- Star rating -->
    ...
    <!-- Bootstrap toggle -->
    <link rel="stylesheet" href="<?php echo base_url('assets/style/bootstrap-switch.css')?>">
    <!-- Main stylesheet -->
    ...
    <link href="<?php echo base_url('admin/js/footable/css/footable.core.css')?>" rel="stylesheet">   
    ...
    <!-- JS -->
    <script src="<?php echo base_url('admin/js/jquery.js')?>"></script> <!-- jQuery -->
    <script src="<?php echo base_url('admin/js/jquery.translator.min.js')?>"></script> <!-- jQuery translate-->

    <script src="<?php echo base_url('admin/js/load-image.js'); ?>"></script>
    <script src="<?php echo base_url('admin/js/bootstrap.js')?>"></script> <!-- Bootstrap -->
    <script src="<?php echo base_url('admin/js/jquery-ui-1.10.3.custom.min.js')?>"></script> <!-- jQuery UI -->
    <script src="<?php echo base_url('admin/js/fullcalendar.min.js')?>"></script> <!-- Full Google Calendar - Calendar -->
    <script src="<?php echo base_url('admin/js/jquery.rateit.min.js')?>"></script> <!-- RateIt - Star rating -->
    <script src="<?php echo base_url('admin/js/jquery.prettyPhoto.js')?>"></script> <!-- prettyPhoto -->
    <script src="<?php echo base_url('admin/js/jquery.mjs.nestedSortable.js');?>"></script>
    <script src="<?php echo base_url('admin/js/jquery.helpers.js');?>"></script>
  ...
  <script type="text/javascript">
    ...
    <!-- jQuery Flot -->
    <script src="<?php echo base_url('admin/js/excanvas.min.js')?>"></script>
    <script src="<?php echo base_url('admin/js/jquery.flot.js')?>"></script>
    <script src="<?php echo base_url('admin/js/jquery.flot.resize.js')?>"></script>
    <script src="<?php echo base_url('admin/js/jquery.flot.pie.js')?>"></script>
    <script src="<?php echo base_url('admin/js/jquery.flot.stack.js')?>"></script>
    <script src="<?php echo base_url('admin/js/sparklines.js')?>"></script> <!-- Sparklines -->
    <script src="<?php echo base_url('admin/js/jquery.cleditor.min.js')?>"></script> <!-- CLEditor -->
    <script src="<?php echo base_url('admin/js/bootstrap-datetimepicker.min.js')?>"></script> <!-- Date picker -->
    <script src="<?php echo base_url('admin/js/bootstrap-switch.min.js')?>"></script> <!-- Bootstrap Toggle -->
    <script src="<?php echo base_url('admin/js/filter.js')?>"></script> <!-- Filter for support page -->
    <script src="<?php echo base_url('admin/js/custom.js')?>"></script> <!-- Custom codes -->
    <script src="<?php echo base_url('admin/js/charts.js')?>"></script> <!-- Custom chart codes -->
    <script src="<?php echo base_url('admin/js/gmap3.min.js')?>"></script>
    <script src="<?php echo base_url('admin/js/markerwithlabel.js')?>"></script>
    <script src="<?php echo base_url('admin/js/blueimp-gallery.min.js')?>"></script>
    <script src="<?php echo base_url('admin/js/footable/js/footable.js')?>"></script>
    <script src="<?php echo base_url('admin/js/jquery.number.js')?>"></script>
    <script src="<?php echo base_url('admin/js/jquery.h5validate.js')?>"></script>
    ...
    <script src="<?php echo base_url('admin/js/fileupload/jquery.iframe-transport.js')?>"></script>
    <!-- The basic File Upload plugin -->
    <script src="<?php echo base_url('admin/js/fileupload/jquery.fileupload.js')?>"></script>
    <!-- The File Upload file processing plugin -->
    <script src="<?php echo base_url('admin/js/fileupload/jquery.fileupload-fp.js')?>"></script>
    <!-- The File Upload user interface plugin -->
    <script src="<?php echo base_url('admin/js/fileupload/jquery.fileupload-ui.js')?>"></script>
    <!-- The XDomainRequest Transport is included for cross-domain file deletion for IE8+ -->
    <!--[if gte IE 8]><script src="admin/js/cors/jquery.xdr-transport.js')?>"></script><![endif]-->
