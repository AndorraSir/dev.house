...
?>
                  ...
                  <div class="widget-foot">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('admin/js/magnific-popup/magnific-popup.css')?>" /> 
<script src="<?php echo base_url('admin/js/magnific-popup/jquery.magnific-popup.js')?>"></script> 
<script>
...
<form id="test-form" class="form-horizontal mfp-hide white-popup-block">
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <img id="ajax-indicator-masking" src="<?php echo base_url(); ?>admin/img/loading.gif" style="display: none;" />
        </div>
    </div>
</form>