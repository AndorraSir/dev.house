...
<div class="container">
      ...
      <table class="table table-bordered" style="border-top: 1px solid #1a1a1a;border-left: 1px solid #1a1a1a;">
        <thead>
          <tr>
            <th>
              <h4><?php _l('Item'); ?></h4>
        ...
        <tbody>
          <tr>
            <td><?php echo  _ch($invoice->reference_code, ''). _ch($invoice->reference_id,''); ?></td>
