...
<script src="<?php echo base_url('admin/js/editable_table/mindmup-editabletable.js')?>"></script>
...
<link rel="stylesheet" href="<?php echo base_url('admin/js/pedigree/style.css')?>">
<script src="<?php echo base_url('admin/js/pedigree/jquery-migrate-1.2.1.min.js')?>"></script>
<script src="<?php echo base_url('admin/js/pedigree/jquery.tree.js')?>"></script>
...
function generate_pedigree_tree(id_key)
{
    ...
    $('#id'+id_key+'.tree').tree_structure({
        ...
        'base_path': '<?php echo base_url('admin/js/pedigree')?>/',
        'on_change': function(){
