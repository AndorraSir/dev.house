<div class="page-head">
    <!-- Page heading -->
      <h2 class="pull-left"><?php echo lang_check('Showroom')?>
          <!-- showroom meta -->
          <span class="page-meta"><?php echo empty($showroom->id) ? lang_check('Add showroom') : lang_check('Edit showroom').' "' . $showroom->id.'"'?></span>
        </h2>
    ...
    <div class="bread-crumb pull-right">
      ...
      <a class="bread-current" href="<?php echo site_url('admin/showroom')?>"><?php echo lang_check('Showrooms')?></a>
    </div>
            ...
            <div class="col-md-8">
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-head">
                  <div class="pull-left"><?php echo lang_check('Showroom data')?></div>
                  ...
                  <div class="padd">
                    ...
                    <?php echo form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form'))?>                              
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    <?php echo form_dropdown('template', $templates_showroom, $this->input->post('template') ? $this->input->post('template') : $showroom->template, 'class="form-control"'); ?>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    <?php echo form_input('address', set_value('address', $showroom->address), 'class="form-control" id="inputAddress" placeholder="'.lang('Address').'"')?>
                                  </div>
                                </div>
                                
                                <div class="form-group">
                                  <label class="col-lg-2 control-label"><?php echo lang('Gps')?></label>
                                  <div class="col-lg-10">
                                    <?php echo form_input('gps', set_value('gps', $showroom->gps), 'class="form-control" id="inputGps" placeholder="'.lang('Gps').'"')?>
                                  </div>
                                </div>
                                
                                <div class="form-group">
                                  <label class="col-lg-2 control-label"><?php echo lang_check('Contact Email')?></label>
                                  <div class="col-lg-10">
                                    <?php echo form_input('contact_email', set_value('contact_email', $showroom->contact_email), 'class="form-control" id="inputContactEmail" placeholder="'.lang_check('Contact Email').'"')?>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-append" id="datetimepicker1">
                                    <?php echo form_input('date_publish', $this->input->post('date_publish') ? $this->input->post('date_publish') : $showroom->date_publish, 'class="picker" data-format="yyyy-MM-dd hh:mm:ss"'); ?>
                                    <span class="add-on">
                               ...
                               <div style="margin-bottom: 0px;" class="tabbable">
                                  ...
                                  <div style="padding-top: 9px; border-bottom: 1px solid #ddd;" class="tab-content">
                                    ...
                                    <div id="<?php echo $key_lang?>" class="tab-pane <?php echo $i==1?'active':''?>">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                            <?php echo form_textarea('body_'.$key_lang, set_value('body_'.$key_lang, $showroom->{'body_'.$key_lang}), 'placeholder="'.lang('Body').'" rows="10" class="ckeditor form-control"')?>
                                          </div>
                                        </div>  
                                    </div>
                                    <?php endforeach;?>
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-10">
                                    ...
                                    <a href="<?php echo site_url('admin/showroom')?>" class="btn btn-default" type="button"><?php echo lang('Cancel')?></a>
                                  </div>
                                </div>
                       <?php echo form_close()?>
                  </div>
...
<?php if(!isset($showroom->id)):?>
<span class="label label-danger"><?php echo lang('After saving, you can add files and images');?></span>
<?php else:?>
<div id="page-files-<?php echo $showroom->id?>" rel="showroom_m">
    <!-- The file upload form used as target for the file upload widget -->
    <form class="fileupload" action="<?php echo site_url('files/upload_showroom/'.$showroom->id);?>" method="POST" enctype="multipart/form-data">
        <!-- Redirect browsers with JavaScript disabled to the origin showroom -->
        <noscript><input type="hidden" name="redirect" value="<?php echo site_url('admin/showroom/edit/'.$showroom->id);?>"></noscript>
...
<?php if(isset($files[$showroom->repository_id]))foreach($files[$showroom->repository_id] as $file ):?>
