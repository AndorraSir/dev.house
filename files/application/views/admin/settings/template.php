                                            ...
                                            <div class = "col-sm-4 col-md-4 thumbnail-template">
                                                <label class="thumbnail-label" for="<?php _che($value);?>">
                                                    <a href="<?php echo site_url("admin/settings/addons");?>"><div class = "thumbnail">
                                                        <?php if(file_exists(FCPATH."admin/img/templates.png")): ?>
                                                            <img src="<?php echo base_url("admin/img/templates.png"); ?>" alt="">
                                                        <?php else: ?>
                                                            <img src="<?php echo base_url("admin/img/242x240.png"); ?>" alt="">
                                                        <?php endif; ?>
                                                        <div class = "caption">
