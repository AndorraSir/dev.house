    ...
    <script type="text/javascript">
        $(function () {
            var pictureLabel = document.createElement("img");
                pictureLabel.src = '<?php echo base_url('admin/img/markers/marker_blue.png');?>';
            ...
            map:{
             ...
             marker:{
                ...
                <?php if(count($estates_all)): foreach($estates_all as $estate):
                    ...
                    $icon_url = base_url('admin/img/markers/marker_blue.png');
                    ...
                    if(isset($value))
                    {
                        ...
                        {
                           /* if(file_exists(FCPATH.'admin/img/markers/'.$value.'.png'))
                            $icon_url = base_url('admin/img/markers/'.$value.'.png');*/
