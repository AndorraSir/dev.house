<div class="page-head">
    <!-- Page heading -->
      <h2 class="pull-left"><?php echo lang('Category')?>
          <!-- page meta -->
          <span class="page-meta"><?php echo empty($expert->id) ? lang('Add a category') : lang('Edit category').' "' . $expert->id.'"'?></span>
        </h2>
                                  ...
                                  <div style="padding-top: 9px; border-bottom: 1px solid #1a1a1a;" class="tab-content">
                                    ...
                                    <div id="<?php echo $key_lang?>" class="tab-pane <?php echo $i==1?'active':''?>">
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                            <?php echo form_input('question_'.$key_lang, set_value('question_'.$key_lang, $expert->{'question_'.$key_lang}), 'class="form-control" id="inputQuestion'.$key_lang.'" placeholder="'.lang('Title').'"')?>
                                          </div>
                                        </div>
